...
const copy = {
  ar: {
    ...
    positioningText: [
      "إنه أصل رقمي خاص بك، يحمل اسم وصول فريداً لا يتكرر.  احجزه مرة واحدة، ثم حدّث الموقع والصور وتعليمات الوصول متى احتجت، بينما يبقى الرابط نفسه الذي يعرفك به الآخرون.",
    ],
